...
module.exports = {
  ...
  title: process.env.NEXT_PUBLIC_SITE_TITLE || "Omansh Krishn's Drive",
  ...
  footer:
  'Owner: <a href="https://omansh_krishn.t.me" target="_blank" rel="noopener noreferrer">Omansh Krishn</a>.',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/omansh-krishn',
    },
  ],
